...
namespace DiscUtils
{
    ...
    public static class VirtualDiskManager
    {
        ...
        public static Dictionary<string, Type> DiskTransports { get; }
        public static Dictionary<string, VirtualDiskFactory> ExtensionMap { get; }
        ...
        public static Dictionary<string, VirtualDiskFactory> TypeMap { get; }
